...
const SupportedBy = () => {
  return (
    <section className="bg-[var(--color-surface)] px-4 py-14 text-[var(--color-text)] sm:px-6 lg:px-8 lg:py-20">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
          {supporters.map((item) => (
            <div
              key={item.name}
              className="flex min-h-28 items-center gap-4 rounded-[1.5rem] border border-[var(--color-border)] bg-[var(--color-surface)] p-5 shadow-sm transition-colors hover:border-[var(--color-border-strong)]"
            >
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-[var(--color-primary)] text-[var(--color-on-primary)]">
                <SupportIcon type={item.icon} className="h-6 w-6" />
              </div>

              <div className="min-w-0">
                <h3 className="truncate text-base font-black tracking-tight text-[var(--color-text)]">
                  {item.name}
                </h3>
        ...
        <div className="mx-auto mt-10 max-w-3xl rounded-[2rem] border border-[var(--color-border)] bg-[var(--color-bg-soft)] p-5 text-center shadow-sm">
