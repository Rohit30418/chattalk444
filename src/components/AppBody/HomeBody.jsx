...
const HomeBody = () => {
  ...
  if (error) {
    return (
      <div className={`flex min-h-screen items-center justify-center bg-slate-50 px-4 text-center dark:bg-[#050713] ${isMobilePwa ? 'pt-0' : 'pt-28'}`}>
  ...
  return (
    <div className={`min-h-screen overflow-x-hidden bg-slate-50 dark:bg-[#050713] ${isMobilePwa ? 'pb-0 pt-0' : 'pb-28 pt-[86px] lg:pb-16 lg:pt-[104px]'}`}>
